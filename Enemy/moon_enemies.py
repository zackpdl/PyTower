...
class Knight(Enemy):
    # Using necromancer sprite sheet with silver/white tint for moon knight appearance
    base_frames = load_sprite_sheet("Necromancer_creativekind-Sheet.png", 160, 128, 1.0)
    images = []
    for frame in base_frames[32:40]:  # Use different set of frames
        # Add silver/white tint for moon theme
        tinted = frame.copy()
        tinted.fill((200, 200, 255, 100), special_flags=pygame.BLEND_RGBA_ADD)
    ...
    def __init__(self):
        ...
        self.vel = 4
        self.if_killed_money_earned = 70
